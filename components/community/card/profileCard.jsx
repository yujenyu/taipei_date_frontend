...
export default function ProfileCard(index) {
  const mockData = {
    userId: 'USERID',
    context:
  ...
  return (
    <>
      <div className="flex card w-[330px] h-[330px] overflow-hidden items-center justify-center border border-grayBorder">
        ...
        <dialog id="photo_modal" className="modal">
          <div
            className="flex modal-box w-auto max-w-none h-auto "
          ...
          >
            ...
            <div className="container flex flex-row">
              <figure className="flex flex-col justify-between w-full card-photo m-0 ">
                <img
                  src="https://daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg"
                  alt="car!"
                  className="object-contain h-[90vh] max-w-[90vh]"
                />
              </figure>

              <div className="flex flex-col card-body h-auto p-0 overflow-auto w-[760px] px-5">
